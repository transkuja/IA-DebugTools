...
namespace crea
{
	...
	bool Agent::loadFromFileJSON(string _filename)
	{
		...
		// Temporary: make sure stats are loaded
		cout << "filename: " << _filename << endl;
		cout << "m_iStrength: " << m_iStrength << endl;
		cout << "m_iDexterity: " << m_iDexterity << endl;
		cout << "m_iIntelligence: " << m_iIntelligence << endl;
		cout << "m_iHealth: " << m_iHealth << endl;
